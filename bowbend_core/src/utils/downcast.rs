//! This is borrowed from the crate as-any but leaves out the blanket
//! implementation.  It ended up causing issues

use core::any::Any;

/// This trait is an extension trait to [`Any`], and adds methods to retrieve a
/// `&dyn Any`
pub trait AsAny: Any {
